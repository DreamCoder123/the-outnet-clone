...
document.getElementById("count1_ash").innerText= cartData.length +" "+"Items";
    ...
    cartData.forEach(function(el, index){
        ...
        minus.addEventListener("click", function(el){
            if(Number(count.innerText) > 1){
                count.innerText --;
                document.getElementById("count_ash").innerText= count.innerText;
                total_price = total_price- Number(pric.innerText);
                console.log(total_price);
                document.getElementById("sub_total_ash").innerText= total_price;
        ...
        document.getElementById("list_ash").append(box);
...
function addtoWishlist(el, index){
    ...
    let a= document.getElementById("sub_total_ash").innerText;
...
document.getElementById("apply_ash").addEventListener("click", promocode);
